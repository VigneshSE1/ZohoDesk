...
export const URL = {
    redeem: {
        getRedeemByApplication: env.REACT_APP_REDEEM_BASEURL +
            "/api/RedemptionRule/getbyGamificationApplicationId/",
        getWalletBalance: env.REACT_APP_REDEEM_BASEURL + "/api/VirtualMoneyBalance/userbalance",
        ...
        redeemProduct: env.REACT_APP_REDEEM_BASEURL + "/api/RedemptionRule/redeemProduct",
    },
    leaderBoard: {
    ...
    privilegeStage: {
        getAll: (applicationId) => `${env.REACT_APP_GAMIFICATION_BASEURL}/privilegeStage/user/application/lookup/${applicationId}`,
    },
    users: {
        get: (userId, appId) => `${env.REACT_APP_GAMIFICATION_BASEURL}/users/${userId}/${appId}`,
    },
};
